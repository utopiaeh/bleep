        ...
        return (
          <li key={tab.id} className="flex items-center justify-between px-3 py-2 gap-3">
            ...
            <button
              ...
              className="rounded-md border border-neutral-700 hover:bg-neutral-800 cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 px-3 py-1 text-xs whitespace-nowrap"
            >
              {busy
                ? 'Clearing…'
                : reloading
